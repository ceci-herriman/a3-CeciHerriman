...
In all of my titles, subtitles, and informational blurbs, I wrote in sequences of several short sentences as opposed to one long sentence to keep information concise and to the point. However, I actively worked to use descriptive words to maintain a high level of helpful detail for users. I made sure to avoid using frontend-related technical terms that I was tempted to use in my instructions, such as "input element". 
